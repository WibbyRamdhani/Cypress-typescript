...
// success checkout products in cart (sauce labs fleece jacket & sauce labs bolt t-shirt)
it('Test Sauce Demo Success Checkout Sauce Labs Fleece Jacket and Bolt T-Shirt in Cart', () => {
    loginPage.login(URL,'standard_user','secret_sauce')
    loginPage.assertLogin()
    dashboardPage.sauceLabsFleeceJacket() 
    dashboardPage.clickBackToProducts()
